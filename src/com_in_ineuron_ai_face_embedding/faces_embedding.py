...
class GenerateFaceEmbedding:
    ...
    def __init__(self, args):
        ...
        self.model = "./insightface/models/model-y1-test2/model,0" ## this perticular file is responsiblr for ceating embeedings on faces
        self.threshold = 1.24
        self.det = 0
    ...
    def genFaceEmbedding(self):
        ...
        for (i, imagePath) in enumerate(imagePaths):
            ...
            nimg = np.transpose(nimg, (2, 0, 1))                                                                        ## why??
        ...
        # save to output
        ## all face's embeddings are stored in .pkl file
